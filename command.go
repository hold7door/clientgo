...
func CreateCommand() *cobra.Command {
	...
	command := &cobra.Command{
		Use:     `clientgo URL`,
		Short:   `clientgo is an HTTP client`,
		Long:    `clientgo is a very simple HTTP client`,
	...
	command.PersistentFlags().StringVarP(&config.UserAgent, "user-agent", "u", "clientgo", "the user agent to be used for requests")
